...
export const Evm = () => {
  return (
    <div>
      ...
      <button onClick={() => Moralis.Evm.connect('magic-link', { email: 'shalom@moralis.io', apiKey: 'pk_live_D058327F385D65BB', chainId: 3, newSession: true })}>Connect via magiclink</button>
