export const sushimakerAbi = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_xSushi', type: 'address' },
    ],
  ...
  {
    inputs: [
      { internalType: 'contract IUniV2[]', name: 'lpTokens', type: 'address[]' },
  ...
  },
  {
    inputs: [],
    name: 'factory',
    outputs: [{ internalType: 'contract IUniV2Factory', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  { inputs: [], name: 'wrapEth', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'xSushi',
    outputs: [{ internalType: 'address', name: '', type: 'address' }],
