...
async function processRequest({ request, params, enveloped, fetchAPI, onResultProcessHooks, }) {
    ...
    if (request.method !== 'GET' && request.method !== 'POST') {
        throw new EnvelopError('GraphQL only supports GET and POST requests.', {
            status: 405,
            headers: {
                Allow: 'GET, POST',
            },
    ...
    if (params.query == null) {
        throw new EnvelopError('Must provide query string.', {
            status: 400,
        });
    }
    try {
    ...
    operation = (_a = getOperationAST(document, params.operationName)) !== null && _a !== void 0 ? _a : undefined;
    if (!operation) {
        throw new EnvelopError('Could not determine what operation to execute.', {
            status: 400,
        });
    }
    if (operation.operation === 'mutation' && request.method === 'GET') {
        throw new EnvelopError('Can only perform a mutation operation from a POST request.', {
            status: 405,
            headers: {
                Allow: 'POST',
            },
...
class YogaServer {
    ...
    async getResponse(request, ...args) {
        ...
        try {
            ...
            let requestParser = () => {
                throw new EnvelopError('Request is not valid', {
                    status: 400,
