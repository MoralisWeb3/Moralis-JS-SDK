...
declare type OperationId = 'getNFTTransfersByBlock';
...
export declare type GetNFTTransfersByBlockJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetNFTTransfersByBlockJSONResponse = SuccessResponse;
export declare type GetNFTTransfersByBlockResponse = ReturnType<typeof deserializeResponse>;
