...
declare type OperationId = 'getPairReserves';
...
export declare type GetPairReservesJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetPairReservesJSONResponse = SuccessResponse;
export declare type GetPairReservesResponse = ReturnType<typeof deserializeResponse>;
