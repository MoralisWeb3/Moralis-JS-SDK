...
declare type OperationId = 'getNFTOwners';
...
export declare type GetNFTOwnersJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetNFTOwnersJSONResponse = SuccessResponse;
export declare type GetNFTOwnersResponse = ReturnType<typeof deserializeResponse>;
