...
declare type OperationId = 'getBlock';
...
export declare type GetBlockJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetBlockJSONResponse = SuccessResponse;
export declare type GetBlockResponse = ReturnType<typeof deserializeResponse>;
