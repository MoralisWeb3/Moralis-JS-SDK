...
declare type OperationId = 'getNFTContractMetadata';
...
export declare type GetNFTContractMetadataJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetNFTContractMetadataJSONResponse = SuccessResponse;
export declare type GetNFTContractMetadataResponse = ReturnType<typeof deserializeResponse>;
