...
declare type OperationId = 'reSyncMetadata';
...
export declare type ReSyncMetadataJSONRequest = ReturnType<typeof serializeRequest>;
export declare type ReSyncMetadataJSONResponse = SuccessResponse;
export declare type ReSyncMetadataResponse = ReturnType<typeof deserializeResponse>;
