...
declare type OperationId = 'getWalletNFTs';
...
export declare type GetWalletNFTsJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetWalletNFTsJSONResponse = SuccessResponse;
export declare type GetWalletNFTsResponse = ReturnType<typeof deserializeResponse>;
