...
declare type OperationId = 'getPairAddress';
...
export declare type GetPairAddressJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetPairAddressJSONResponse = SuccessResponse;
export declare type GetPairAddressResponse = ReturnType<typeof deserializeResponse>;
