...
declare type OperationId = 'getNFTTrades';
...
export declare type GetNFTTradesJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetNFTTradesJSONResponse = SuccessResponse;
export declare type GetNFTTradesResponse = ReturnType<typeof deserializeResponse>;
