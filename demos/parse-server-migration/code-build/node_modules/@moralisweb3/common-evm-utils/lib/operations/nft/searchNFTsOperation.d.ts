...
declare type OperationId = 'searchNFTs';
...
export declare type SearchNFTsJSONRequest = ReturnType<typeof serializeRequest>;
export declare type SearchNFTsJSONResponse = SuccessResponse;
export declare type SearchNFTsResponse = ReturnType<typeof deserializeResponse>;
