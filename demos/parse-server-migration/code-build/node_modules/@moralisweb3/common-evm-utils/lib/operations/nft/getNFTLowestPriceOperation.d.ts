...
declare type OperationId = 'getNFTLowestPrice';
...
export declare type GetNFTLowestPriceJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetNFTLowestPriceJSONResponse = SuccessResponse;
export declare type GetNFTLowestPriceResponse = ReturnType<typeof deserializeResponse>;
