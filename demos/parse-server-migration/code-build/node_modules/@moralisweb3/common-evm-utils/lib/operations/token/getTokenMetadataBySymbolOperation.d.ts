...
declare type OperationId = 'getTokenMetadataBySymbol';
...
export declare type GetTokenMetadataBySymbolJSONRequest = ReturnType<typeof serializeRequest>;
export declare type GetTokenMetadataBySymbolJSONResponse = SuccessResponse;
export declare type GetTokenMetadataBySymbolResponse = ReturnType<typeof deserializeResponse>;
