...
var makeEvmRequestMessage = function (core, _a) {
    ...
    return new api_utils_1.OperationResolver(common_auth_utils_1.requestChallengeEvmOperation, Auth_1.BASE_URL, core).fetch(__assign({ chainId: common_evm_utils_1.EvmChain.create(chain).apiId, address: common_evm_utils_1.EvmAddress.create(address).checksum }, options));
};
