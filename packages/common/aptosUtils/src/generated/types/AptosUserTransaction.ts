import { AptosUserTransactionChanges, AptosUserTransactionChangesInput, AptosUserTransactionChangesJSON } from '../types/AptosUserTransactionChanges';
import { AptosAddress, AptosAddressInput, AptosAddressJSON } from '../../dataTypes';
import { AptosUserTransactionPayload, AptosUserTransactionPayloadInput, AptosUserTransactionPayloadJSON } from '../types/AptosUserTransactionPayload';
import { AptosUserTransactionSignature, AptosUserTransactionSignatureInput, AptosUserTransactionSignatureJSON } from '../types/AptosUserTransactionSignature';
...
export interface AptosUserTransactionInput {
  ...
  readonly changes: AptosUserTransactionChangesInput | AptosUserTransactionChanges;
  ...
  readonly payload: AptosUserTransactionPayloadInput | AptosUserTransactionPayload;
  readonly signature: AptosUserTransactionSignatureInput | AptosUserTransactionSignature;
...
export class AptosUserTransaction {
  ...
  public readonly changes: AptosUserTransactionChanges;
  /**
  ...
  public readonly payload: AptosUserTransactionPayload;
  public readonly signature: AptosUserTransactionSignature;
  /**
