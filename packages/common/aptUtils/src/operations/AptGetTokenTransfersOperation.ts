...
export interface AptGetTokenTransfersOperationRequest {
...
export const AptGetTokenTransfersOperation = {
  ...
  serializeRequest(request: AptGetTokenTransfersOperationRequest): AptGetTokenTransfersOperationRequestJSON {
