...
describe('getBlockByHeight', () => {
  ...
  it('returns an info', async () => {
    ...
    expect(tx1.proposer).toBe('0xc29a231581f243ddcbf97de8b93c8aabb466dd6912ce5ba12579ff2f13cb8da5');
    ...
    expect(event.guid.accountAddress).toBe('0x1');
    ...
    expect(change1.data.data).toBeDefined(); // TODO: swagger needs to be updated
