...
import { StreamErc1155ApprovalData, StreamErc1155ApprovalInput } from './types';
...
export class StreamErc1155Approval implements MoralisDataObject {
   ...
   */
  static create(data: StreamErc1155Approvalish, core?: MoralisCore) {
  ...
  constructor(data: StreamErc1155ApprovalInput, core: MoralisCore) {
