import { getNFTMetadataOperation, GetNFTMetadataRequest, GetNFTMetadataResponse } from '@moralisweb3/common-sol-utils';
...
export const useSolNFTMetadata = (request: GetNFTMetadataRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR<GetNFTMetadataResponse>('solApi/getNFTMetadata', axiosFetcher, SWRConfig);
