import { getNFTTransfersOperation, GetNFTTransfersRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmNFTTransfers = (request: GetNFTTransfersRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getNFTTransfers', getNFTTransfersOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
