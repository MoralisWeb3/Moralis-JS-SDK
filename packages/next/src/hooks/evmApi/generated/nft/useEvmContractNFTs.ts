import { getContractNFTsOperation, GetContractNFTsRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmContractNFTs = (request: GetContractNFTsRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getContractNFTs', getContractNFTsOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
