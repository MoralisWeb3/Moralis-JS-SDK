import { getNFTMetadataOperation, GetNFTMetadataRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmNFTMetadata = (request: GetNFTMetadataRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getNFTMetadata', getNFTMetadataOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
