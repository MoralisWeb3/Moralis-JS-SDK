import { getWalletNFTsOperation, GetWalletNFTsRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmWalletNFTs = (request: GetWalletNFTsRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getWalletNFTs', getWalletNFTsOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
