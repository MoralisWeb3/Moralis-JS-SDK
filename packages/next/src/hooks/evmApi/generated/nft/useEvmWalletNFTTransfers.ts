import { getWalletNFTTransfersOperation, GetWalletNFTTransfersRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmWalletNFTTransfers = (request: GetWalletNFTTransfersRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getWalletNFTTransfers', getWalletNFTTransfersOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
