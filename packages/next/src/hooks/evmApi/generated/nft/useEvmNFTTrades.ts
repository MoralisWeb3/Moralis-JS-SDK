import { getNFTTradesOperation, GetNFTTradesRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmNFTTrades = (request: GetNFTTradesRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getNFTTrades', getNFTTradesOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
