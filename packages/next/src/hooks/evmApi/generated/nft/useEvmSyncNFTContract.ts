import { syncNFTContractOperation, SyncNFTContractRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmSyncNFTContract = (request: SyncNFTContractRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/syncNFTContract', syncNFTContractOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
