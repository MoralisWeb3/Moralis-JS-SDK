import { getWalletNFTCollectionsOperation, GetWalletNFTCollectionsRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmWalletNFTCollections = (request: GetWalletNFTCollectionsRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getWalletNFTCollections', getWalletNFTCollectionsOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
