import { getContractEventsOperation, GetContractEventsRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmContractEvents = (request: GetContractEventsRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getContractEvents', getContractEventsOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
