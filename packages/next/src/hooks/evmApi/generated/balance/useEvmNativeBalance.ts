import { getNativeBalanceOperation, GetNativeBalanceRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmNativeBalance = (request: GetNativeBalanceRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getNativeBalance', getNativeBalanceOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
