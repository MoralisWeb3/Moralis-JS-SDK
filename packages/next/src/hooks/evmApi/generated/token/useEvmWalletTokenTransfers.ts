import { getWalletTokenTransfersOperation, GetWalletTokenTransfersRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmWalletTokenTransfers = (request: GetWalletTokenTransfersRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getWalletTokenTransfers', getWalletTokenTransfersOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
