import { getTokenMetadataBySymbolOperation, GetTokenMetadataBySymbolRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmTokenMetadataBySymbol = (request: GetTokenMetadataBySymbolRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getTokenMetadataBySymbol', getTokenMetadataBySymbolOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
