import { getDateToBlockOperation, GetDateToBlockRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmDateToBlock = (request: GetDateToBlockRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getDateToBlock', getDateToBlockOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
