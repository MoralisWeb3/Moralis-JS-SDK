import { getBlockOperation, GetBlockRequest } from '@moralisweb3/common-evm-utils';
...
export const useEvmBlock = (request: GetBlockRequest, SWRConfig?: SWRConfiguration) => {
  ...
  const { data, error, mutate, isValidating } = useSWR(['evmApi/getBlock', getBlockOperation.serializeRequest(request, Moralis.Core)], axiosFetcher, SWRConfig);
