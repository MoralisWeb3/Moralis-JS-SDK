import { GetTokenTransfersJSONRequest, getTokenTransfersOperation } from 'moralis/common-evm-utils';
...
type RequestQuery = Pick<
  ...
  'chain' | 'subdomain' | 'fromBlock' | 'toBlock' | 'fromDate' | 'toDate' | 'offset' | 'limit'
>;
