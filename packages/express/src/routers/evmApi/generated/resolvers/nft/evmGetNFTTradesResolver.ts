import { GetNFTTradesJSONRequest, getNFTTradesOperation } from 'moralis/common-evm-utils';
...
type RequestQuery = Pick<
  ...
  'chain' | 'fromBlock' | 'toBlock' | 'fromDate' | 'toDate' | 'providerUrl' | 'marketplace' | 'cursor' | 'limit'
>;
