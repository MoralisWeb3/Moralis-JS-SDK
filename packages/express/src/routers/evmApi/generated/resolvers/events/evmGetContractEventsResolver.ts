import { GetContractEventsJSONRequest, getContractEventsOperation } from 'moralis/common-evm-utils';
...
type RequestQuery = Pick<
  ...
  'chain' | 'subdomain' | 'providerUrl' | 'fromBlock' | 'toBlock' | 'fromDate' | 'toDate' | 'topic' | 'offset' | 'limit'
>;
