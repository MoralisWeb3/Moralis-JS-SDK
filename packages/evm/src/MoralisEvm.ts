...
import { ExecuteFunctionOptions, makeExecutefunction } from './chainMethods/executeFunction';
...
export class MoralisEvm extends NetworkModule<EvmNetworkEventMap> {
  ...
  executeFunction = (data: ExecuteFunctionOptions) => makeExecutefunction(this.provider)(data);
}
