...
import { EvmChainish, EvmAddressish, EvmAddress, EvmTransaction } from '@moralisweb3/common-evm-utils';
...
export const getWalletTransactions = createPaginatedEndpointFactory((core) =>
