...
export abstract class ClientEvmApi extends ApiModule {
  ...
  public readonly token = {
   ...
   getTokenPairOhlc: (request: GetTokenPairOhlcOperationRequest): Promise<PaginatedResponseV3Adapter<GetTokenPairOhlcOperationResponse, GetTokenPairOhlcOperationResponseJSON>> => {
      return new PaginatedOperationV3Resolver(GetTokenPairOhlcOperation, this.baseUrl, this.core).fetch(request, null);
    },
