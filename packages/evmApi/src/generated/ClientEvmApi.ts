...
export abstract class ClientEvmApi extends ApiModule {
  ...
  public readonly utils = {
   ...
   contractsReview: (request: ContractsReviewOperationRequest, body: ContractsReviewOperationBody): Promise<ResponseAdapter<ContractsReviewOperationResponse, ContractsReviewOperationResponseJSON>> => {
      return new OperationV3Resolver(ContractsReviewOperation, this.baseUrl, this.core).fetch(request, body);
    },
