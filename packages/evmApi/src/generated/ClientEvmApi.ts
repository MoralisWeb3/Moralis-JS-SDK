...
import { NullableOperationResolver, OperationResolver, PaginatedOperationResolver, PaginatedResponseV3Adapter, PaginatedOperationV3Resolver, ResponseV3Adapter, OperationV3Resolver } from '@moralisweb3/api-utils';
...
export abstract class ClientEvmApi extends ApiModule {
  ...
  public readonly utils = {
   ...
   web3ApiVersion: (): Promise<ResponseV3Adapter<Web3ApiVersionOperationResponse, Web3ApiVersionOperationResponseJSON>> => {
      return new OperationV3Resolver(Web3ApiVersionOperation, this.baseUrl, this.core).fetch({}, null);
    },
   endpointWeights: (): Promise<ResponseV3Adapter<EndpointWeightsOperationResponse, EndpointWeightsOperationResponseJSON>> => {
